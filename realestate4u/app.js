...
function greetingHtml() {
  if (!GREETING) return "";
  var img = '<img src="' + GREETING.imageUrl + '" alt="' + (GREETING.caption || "Greetings") + '">';
  ...
  app.innerHTML = '' +
    '<section class="hero">' +
      '<div class="hero-inner">' +
        '<div class="hero-copy">' +
          '<h1>Own land on the road to Hyderabad\'s next boomtowns</h1>' +
    ...
    '<section class="section">' +
      ...
      '<div class="detail-grid">' +
        ...
        '<div class="side-panel">' +
          ...
          '<a class="side-btn" href="#" id="detail-enquire">Enquire now</a>' +
          mapsBtn + brochureBtn +
        '</div>' +
      '</div>' +
    '</section>';
